...
public class Pipeline {
	 ...
	 */
	public void process(Mat camera) {
		// Step CV_resize0:
		Mat cvResizeSrc = camera;
		...
		double[] hsvThresholdHue = {72.33721497378367, 140.83617747440275};
		double[] hsvThresholdSaturation = {0.0, 250.02404591995037};
		double[] hsvThresholdValue = {150.66289667892985, 255.0};
